...
public class ToastModule extends ReactContextBaseJavaModule{
    ...
    private static final String ERROR_PROMISE_A = "ERROR_PROMISE_A";
    ...
    public void doCallbackTask(int aNumber,
            ...
            try {
                //Do something
                if(aNumber == 100) {
                    throw new Exception("Input number is 100, cannot do task !");
                }
                //success
                String name = "Hoang";
    ...
    @ReactMethod
    public void doPromiseTask(int aNumber,
                               Promise promise) {
        try {
            ...
            promise.reject(ERROR_PROMISE_A, e);
        }
    }
}
